...
function set_v2ray_config(){
	...
	if [[ ${install_type} = "1" ]]; then
		wget -O "/etc/v2ray/config.json" "https://beta.v2ray-install.ml/socks5.json"
		input_port
		service_restart
		echo_v2ray_info
		echo "1" > /etc/v2ray/install_type.txt
	elif [[ ${install_type} = "2" ]]; then
		wget -O "/etc/v2ray/config.json" "https://beta.v2ray-install.ml/shadowsocks.json"
		input_port
		...
		wget -O "/etc/v2ray/config.json" "https://beta.v2ray-install.ml/shadowsocks-mkcp.json"
		clear
		input_port
		stty erase '^H' && read -p "请输入SS的加密方式(默认加密方式：ase-256-gcm)：" install_ss_encryption_type
		if [[ ${install_ss_encryption_type} = "" ]]; then
		...
		wget -O "/etc/v2ray/config.json" "https://beta.v2ray-install.ml/tcp.json"
		clear
		input_port
		...
		wget -O "/etc/v2ray/config.json" "https://beta.v2ray-install.ml/tcp-dynport.json"
		clear
		...
		wget -O "/etc/v2ray/config.json" "https://beta.v2ray-install.ml/tcp-http.json"
		clear
		install_port="80"
		port_check
		sed -i "s/UserUUID/${UUID}/g" "/etc/v2ray/config.json"
		...
		install_acme
		wget -O "/etc/v2ray/config.json" "https://beta.v2ray-install.ml/tcp-tls.json"
		clear
		install_port="443"
		port_check
		sed -i "s/UserUUID/${UUID}/g" "/etc/v2ray/config.json"
		...
		wget -O "/etc/v2ray/config.json" "https://beta.v2ray-install.ml/mkcp.json"
		clear
		input_port
		sed -i "s/UserUUID/${UUID}/g" "/etc/v2ray/config.json"
		service_restart
		...
		wget -O "/etc/v2ray/config.json" "https://beta.v2ray-install.ml/mkcp-utp.json"
		clear
		input_port
		sed -i "s/UserUUID/${UUID}/g" "/etc/v2ray/config.json"
		service_restart
		...
		wget -O "/etc/v2ray/config.json" "https://beta.v2ray-install.ml/mkcp-srtp.json"
		clear
		input_port
		sed -i "s/UserUUID/${UUID}/g" "/etc/v2ray/config.json"
		service_restart
		...
		wget -O "/etc/v2ray/config.json" "https://beta.v2ray-install.ml/mkcp-wechatvideo.json"
		clear
		input_port
		sed -i "s/UserUUID/${UUID}/g" "/etc/v2ray/config.json"
		service_restart
		...
		wget -O "/etc/v2ray/config.json" "https://beta.v2ray-install.ml/mkcp-dynport.json"
		clear
		input_port
		sed -i "s/UserUUID/${UUID}/g" "/etc/v2ray/config.json"
		service_restart
		...
		wget -O "/etc/v2ray/config.json" "https://beta.v2ray-install.ml/mkcp-wechatvideo-dynport.json"
		clear
		input_port
		sed -i "s/UserUUID/${UUID}/g" "/etc/v2ray/config.json"
		service_restart
		...
		install_acme
		wget -O "/etc/v2ray/config.json" "https://beta.v2ray-install.ml/websocket-tls-host.json"
		clear
		install_port="443"
		port_check
		clear
		...
		install_acme
		wget -O "/etc/v2ray/config.json" "https://beta.v2ray-install.ml/websocket-tls-path.json"
		clear
		install_port="443"
		port_check
		clear
		...
		echo "${install_domain}" > /etc/v2ray/full_domain.txt
		wget -O "/etc/v2ray/config.json" "https://beta.v2ray-install.ml/websocket-tls-website-path.json"
		wget -qO /usr/local/caddy/Caddyfile "https://beta.v2ray-install.ml/websocket-tls-website-path.Caddyfile"
		...
		generate_domain
		issue_cfssl
		wget -O "/etc/v2ray/config.json" "https://beta.v2ray-install.ml/websocket-tls-website-path-domain.json"
		wget -qO /usr/local/caddy/Caddyfile "https://beta.v2ray-install.ml/websocket-tls-website-path-domain.Caddyfile"
		sed -i "s/PathUUID/${UUID2}/g" "/usr/local/caddy/Caddyfile"
		sed -i "s/PathUUID/${UUID2}/g" "/etc/v2ray/config.json"
		sed -i "s/V2RayListenPort/${v2_listen_port}/g" "/etc/v2ray/config.json"
		sed -i "s/UserUUID/${UUID}/g" "/etc/v2ray/config.json"
		...
		mkdir /etc/v2ray/pages
		wget -qO /etc/v2ray/pages/index.html "https://beta.v2ray-install.ml/v2ray-index.html"
		wget -qO /etc/v2ray/pages/404.html "https://beta.v2ray-install.ml/v2ray-404.html"
		service_restart
		echo_v2ray_info
...
function generate_domain(){
	...
	v2_domain=$(curl https://beta.v2ray-install.ml/domain.txt)
	zone_id=$(curl https://beta.v2ray-install.ml/zone_id.txt)
